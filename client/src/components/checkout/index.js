            ...
            <Card style={{padding: 15}}>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <div className={styles.cardFormButtonsContainer}>
                        <Form.Button type={'button'} style={{marginRight: 5}} onClick={() => history.push('/')}>Cancel</Form.Button>
                        <Form.Button primary
...
function ExistingTab(props) {
    ...
    useEffect(( ) => {
        let tempSum = 0
        if (props.stripe.tab && (props.stripe.tab?.length ?? 0) > 0) {
            ...
            <Card style={{padding: 15}}>
                ...
                <div>
                    ...
                    <div className={styles.timerBox}>
                        {timerComponents.length > 0 && <p>Time Left On Tab</p>}
                        {timerComponents.length ? (timerComponents) : <span>Tab Expired</span>}
                    </div>
                    <br/>
                    <div className={styles.cardFormButtonsContainer}>
                        <Button type={'button'} style={{marginRight: 5}} onClick={() => history.push('/')}>Cancel</Button>
                        <Button primary disabled={props.stripe.loading || props.stripe.status !== 'unfulfilled'} onClick={() => props.closeTab(props.auth.user._id)}>Close
                            Tab</Button>
                    </div>
                </div>
            </Card>
